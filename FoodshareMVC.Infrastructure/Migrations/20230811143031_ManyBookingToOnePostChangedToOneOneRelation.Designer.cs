...
namespace FoodshareMVC.Infrastructure.Migrations
{
    ...
    [Migration("20230811143031_ManyBookingToOnePostChangedToOneOneRelation")]
    partial class ManyBookingToOnePostChangedToOneOneRelation
    {
            ...
            modelBuilder.Entity("FoodshareMVC.Domain.Models.PostTag", b =>
                {
                    ...
                    b.HasOne("FoodshareMVC.Domain.Models.BaseInherited.Tag", "Tag")
                        .WithMany("PostTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
